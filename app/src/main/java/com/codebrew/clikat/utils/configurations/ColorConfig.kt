...
//-->DE216C
    ...
    @kotlin.jvm.JvmField
    var colorblack:String?="#B1B1B1"
    @kotlin.jvm.JvmField
    var colorBlue:String?="#4A7DB2"
    @kotlin.jvm.JvmField
    var white:String?="#ffffff"

    @kotlin.jvm.JvmField
    var black:String?="#4D5466"

    @kotlin.jvm.JvmField
    var dark_grey:String?="#7B838D"

    @kotlin.jvm.JvmField
    var dark_grey1:String?="#4D5466"

    @kotlin.jvm.JvmField
    var lightBlack:String?="#4D4D4D"

    @kotlin.jvm.JvmField
    var lightGrey:String?="#B7B7B7"

    @kotlin.jvm.JvmField
    var light_blue:String?="#4A81B3"

    @kotlin.jvm.JvmField
    var blue_bg:String?="#357EB6"

    @kotlin.jvm.JvmField
    var splash_bg:String?="#FEFAEB"

    @kotlin.jvm.JvmField
    var primaryColor: String? = "#ACB1AD"

    @kotlin.jvm.JvmField
    var appBackground ="#ffffff"//if (BuildConfig.CLIENT_CODE == "craveqatar123_0896") "#FEFAEB" else "#ffffff"
    @kotlin.jvm.JvmField
    var listBackground = if (BuildConfig.CLIENT_CODE == "craveqatar123_0896") "#FEFAEB" else "#ffffff"
    @kotlin.jvm.JvmField
    var appBackgroundCardView = if (BuildConfig.CLIENT_CODE == "craveqatar123_0896") appBackground else "#ffffff"
    @kotlin.jvm.JvmField
    var textAppTitle: String? = "#4D5466"
    @kotlin.jvm.JvmField
    ...
    @kotlin.jvm.JvmField
    var toolbarColor: String? = if (BuildConfig.CLIENT_CODE == "craveqatar123_0896") appBackground else "#FFFFFF"  /*212B36*/
    @kotlin.jvm.JvmField
    ...
    @kotlin.jvm.JvmField
    var homelistBackground = if (BuildConfig.CLIENT_CODE == "craveqatar123_0896") "#FEFAEB" else "#F5F7FB"
    @kotlin.jvm.JvmField
